<section class="ps-wrap checkout-success">
    ...
    //Data
    $date_request = new DateTime($order->get_date_completed());
    ...
    <?php if (isset($_REQUEST['link_boleto']) && $_REQUEST['link_boleto']): ?>
    ...
    <?php endif; ?>
    <?php if (isset($_REQUEST['link_debit']) && $_REQUEST['link_debit']): ?>
        <div class="text-center">
    ...
    <?php if (isset($_REQUEST['checkout_type']) && $_REQUEST['checkout_type'] == 'boleto'): ?>
        <div class="text-center">
    ...
    <?php if (isset($_REQUEST['checkout_type']) && $_REQUEST['checkout_type'] == 'debit'): ?>
        <div class="text-center">
